...
pub fn run() {
    ...
    let builder = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::windsurf_oauth_login_start,
            commands::windsurf_oauth_login_complete,
            commands::windsurf_oauth_login_cancel,
            commands::windsurf_oauth_submit_callback_url,
